const url1 = 'http://127.0.0.1:5500/js/zfirst-api.js';
...
.then( result => { 
    ...
    let div_area = document.getElementById("products1");
        ...
        function(item){
          ...
          `<div class="card d-inline-flex" style="width: 18rem;">
              ...
              <div class="card-body">
                  ...
                  <p class="card-text" id="pri${item.id}"> Php ${item.price}</p>
 ...
 // connected parameter idea in function addOrder: id. ${item.id} is now equal to id
